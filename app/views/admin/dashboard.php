                        ...
                        <div class="bg-gradient-to-b from-green-200 to-green-100 border-b-4 border-green-600 rounded-lg shadow-xl p-5">
                            <div class="flex flex-row items-center">
                                ...
                                <div class="flex-1 text-right md:text-center">
                                    <h2 class="font-bold uppercase text-gray-600">Total Courses</h2>
                                   <p class="font-bold text-3xl"><?=$data['totalCourses']  ?> <span class="text-green-500"><i class="fas fa-caret-up"></i></span></p>
                                </div>
                            </div>
                        </div>
                        <!--/Metric Card-->
                    ...
                    <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                        ...
                        <div class="bg-gradient-to-b from-yellow-200 to-yellow-100 border-b-4 border-yellow-600 rounded-lg shadow-xl p-5">
                            ...
                            <div class="flex-shrink pr-4">
                                ...
                                <div class="flex-1 text-right md:text-center">
                                    <h2 class="font-bold uppercase text-gray-600">Most Popular Course</h2>
                                    <p class="font-bold text-3xl"><?=$data['mostPopularCourse']['title'] ?></p>
                                </div>
                                <!-- <div class="flex-shrink pr-4">
                                ...
                                <div class="flex-1 text-right md:text-center">
                                    ...
                                    <p class="font-bold text-3xl"><span class="text-yellow-600"><i class="fas fa-caret-up"></i></span></p>
                                </div> -->
                            </div>
                        </div>
                        <!--/Metric Card-->
                    ...
                    <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                        ...
                        <div class="bg-gradient-to-b from-blue-200 to-blue-100 border-b-4 border-blue-500 rounded-lg shadow-xl p-5">
                            ...
                            <div class="flex-shrink pr-4">
                                ...
                                <div class="flex-1 text-right md:text-center">
                                    <h2 class="font-bold uppercase text-gray-600">Total Catigories</h2>
                                    <p class="font-bold text-3xl"><?=$data['CategoriesCount']?><span class="text-red-500"><i class="fas fa-caret-up"></i></span></p>
                                </div>
                            </div>
                        </div>
                        <!--/Metric Card-->
                    ...
                    <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                        ...
                        <div class="bg-gradient-to-b from-red-200 to-red-100 border-b-4 border-red-500 rounded-lg shadow-xl p-5">
                            ...
                            <div class="flex-shrink pr-4">
                                ...
                                <div class="flex-1 text-right md:text-center">
                                    <h2 class="font-bold uppercase text-gray-600">Top 3 Teachers</h2>
                                    <p class="font-bold uppercase text-black">Teacher 1</p>
                                    <p class="font-bold uppercase text-black">Teacher 2</p>
                                    <p class="font-bold uppercase text-black">Teacher 3</p>
                                </div>
                            </div>
                        </div>
                        <!--/Metric Card-->
